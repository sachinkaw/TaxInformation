...
namespace TaxInformation.Models
{
    ...
    public partial class Org
    {
        ...
        public Nullable<decimal> LeaseCostPercentage { get; set; }
        ...
        public string BillingLandlineNumber { get; set; }
        public string BillingLandlineNumberFixed { get; set; }
        public string BillingContactPhonefixed { get; set; }
        public Nullable<int> Capacity { get; set; }
        public string SiteSignatureImage { get; set; }
        public Nullable<bool> AllowArchivedMsg { get; set; }
